...
for (const width of [100, 126, 154, 176]) {
  ...
  assert.equal(Math.max(...destinations.map(item => item.y + item.h)), 449.25);
  assert.equal(449.25 - 443.25, 6, "icicles may overhang collision by exactly 6px");
}
