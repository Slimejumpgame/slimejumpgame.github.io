(() => {
  ...
  const ACHIEVEMENT_REGISTRY = Object.freeze([
    ...
    Object.freeze({id: "fashion_icon", icon: "🎩", name: "FASHION ICON", description: "Schalte alle Cosmetics frei.", secret: false}),
    ...
    Object.freeze({id: "clean_machine", icon: "🧼", name: "CLEAN MACHINE", description: "Schließe 25 Level hintereinander ohne Tod ab.", secret: false}),
