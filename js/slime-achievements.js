(() => {
  ...
  const ACHIEVEMENT_REGISTRY = Object.freeze([
    ...
    Object.freeze({id: "perk_up", icon: "🧩", name: "PERK UP", description: "Schalte deine erste Fähigkeit frei.", secret: false, conditionKey: "unlocked-perks-1", category: "perks"}),
    Object.freeze({id: "fully_loaded", icon: "🧰", name: "FULLY LOADED", description: "Schalte alle implementierten Fähigkeiten frei.", secret: false, conditionKey: "unlocked-all-implemented-perks", category: "perks"}),
    Object.freeze({id: "triple_threat", icon: "🃏", name: "TRIPLE THREAT", description: "Rüste gleichzeitig 3 Fähigkeiten aus.", secret: false, conditionKey: "selected-perks-3", category: "perks"}),
    Object.freeze({id: "build_online", icon: "🔧", name: "BUILD ONLINE", description: "Schließe ein Level mit 3 aktiven Fähigkeiten ab.", secret: false, conditionKey: "complete-with-three-active-run-perks", category: "skill"}),
